...
namespace Api.Service.Test.AutoMapper
{
    public class UfMapper : BaseTesteService
    {
        ...
        public void E_Possivel_Mapear_os_Modelos_Uf()
        {
            ...
            Assert.Equal(entity.Estado, model.Estado);
            ...
            Assert.Equal(userDto.Estado, entity.Estado);
            ...
            for (int i = 0; i < listaDto.Count(); i++)
            {
                ...
                Assert.Equal(listaDto[i].Estado, listaEntity[i].Estado);
            ...
            Assert.Equal(userModel.Estado, model.Estado);
